...
import 'equip_yellow_pants_model.dart';
export 'equip_yellow_pants_model.dart';

class EquipYellowPantsWidget extends StatefulWidget {
  const EquipYellowPantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipYellowPantsWidget> createState() => _EquipYellowPantsWidgetState();
}

class _EquipYellowPantsWidgetState extends State<EquipYellowPantsWidget> {
  late EquipYellowPantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipYellowPantsModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_YELLOW_PANTS_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.yellowPants) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().yellowPantsEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_YELLOW_PANTS_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_YELLOW_PANTS_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
