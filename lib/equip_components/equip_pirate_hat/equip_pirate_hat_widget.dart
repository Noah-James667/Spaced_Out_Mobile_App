...
import 'equip_pirate_hat_model.dart';
export 'equip_pirate_hat_model.dart';

class EquipPirateHatWidget extends StatefulWidget {
  const EquipPirateHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipPirateHatWidget> createState() => _EquipPirateHatWidgetState();
}

class _EquipPirateHatWidgetState extends State<EquipPirateHatWidget> {
  late EquipPirateHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipPirateHatModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_PIRATE_HAT_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.pirateHat) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().pirateHatEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_PIRATE_HAT_COMP_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_PIRATE_HAT_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
