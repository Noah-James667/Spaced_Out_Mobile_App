...
import 'equip_purple_ship_model.dart';
export 'equip_purple_ship_model.dart';

class EquipPurpleShipWidget extends StatefulWidget {
  const EquipPurpleShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipPurpleShipWidget> createState() => _EquipPurpleShipWidgetState();
}

class _EquipPurpleShipWidgetState extends State<EquipPurpleShipWidget> {
  late EquipPurpleShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipPurpleShipModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_PURPLE_SHIP_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.purpleShip) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().purpleShipEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_PURPLE_SHIP_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_PURPLE_SHIP_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
