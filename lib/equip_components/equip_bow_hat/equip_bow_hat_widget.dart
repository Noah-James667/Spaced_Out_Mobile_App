...
import 'equip_bow_hat_model.dart';
export 'equip_bow_hat_model.dart';

class EquipBowHatWidget extends StatefulWidget {
  const EquipBowHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipBowHatWidget> createState() => _EquipBowHatWidgetState();
}

class _EquipBowHatWidgetState extends State<EquipBowHatWidget> {
  late EquipBowHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipBowHatModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_BOW_HAT_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
