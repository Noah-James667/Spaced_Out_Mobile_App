...
import 'equip_wizard_hat_model.dart';
export 'equip_wizard_hat_model.dart';

class EquipWizardHatWidget extends StatefulWidget {
  const EquipWizardHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipWizardHatWidget> createState() => _EquipWizardHatWidgetState();
}

class _EquipWizardHatWidgetState extends State<EquipWizardHatWidget> {
  late EquipWizardHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipWizardHatModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_WIZARD_HAT_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.wizardHat) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().magicHatEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_WIZARD_HAT_COMP_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_WIZARD_HAT_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
