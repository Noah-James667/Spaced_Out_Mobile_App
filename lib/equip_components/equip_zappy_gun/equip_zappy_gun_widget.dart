...
import 'equip_zappy_gun_model.dart';
export 'equip_zappy_gun_model.dart';

class EquipZappyGunWidget extends StatefulWidget {
  const EquipZappyGunWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipZappyGunWidget> createState() => _EquipZappyGunWidgetState();
}

class _EquipZappyGunWidgetState extends State<EquipZappyGunWidget> {
  late EquipZappyGunModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipZappyGunModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_ZAPPY_GUN_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
