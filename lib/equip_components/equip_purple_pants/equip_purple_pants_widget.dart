...
import 'equip_purple_pants_model.dart';
export 'equip_purple_pants_model.dart';

class EquipPurplePantsWidget extends StatefulWidget {
  const EquipPurplePantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipPurplePantsWidget> createState() => _EquipPurplePantsWidgetState();
}

class _EquipPurplePantsWidgetState extends State<EquipPurplePantsWidget> {
  late EquipPurplePantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipPurplePantsModel());
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_PURPLE_PANTS_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.purplePants) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().purplePantsEquip = 1;
