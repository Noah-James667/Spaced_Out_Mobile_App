...
import 'equip_space_sword_model.dart';
export 'equip_space_sword_model.dart';

class EquipSpaceSwordWidget extends StatefulWidget {
  const EquipSpaceSwordWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipSpaceSwordWidget> createState() => _EquipSpaceSwordWidgetState();
}

class _EquipSpaceSwordWidgetState extends State<EquipSpaceSwordWidget> {
  late EquipSpaceSwordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipSpaceSwordModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_SPACE_SWORD_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
