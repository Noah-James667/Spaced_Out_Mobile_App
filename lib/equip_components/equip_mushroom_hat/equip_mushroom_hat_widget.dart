...
import 'equip_mushroom_hat_model.dart';
export 'equip_mushroom_hat_model.dart';

class EquipMushroomHatWidget extends StatefulWidget {
  const EquipMushroomHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipMushroomHatWidget> createState() => _EquipMushroomHatWidgetState();
}

class _EquipMushroomHatWidgetState extends State<EquipMushroomHatWidget> {
  late EquipMushroomHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipMushroomHatModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_MUSHROOM_HAT_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.mushroomHat) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().mushroomHatEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_MUSHROOM_HAT_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_MUSHROOM_HAT_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
