...
import 'equip_light_blue_pants_model.dart';
export 'equip_light_blue_pants_model.dart';

class EquipLightBluePantsWidget extends StatefulWidget {
  const EquipLightBluePantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipLightBluePantsWidget> createState() =>
      _EquipLightBluePantsWidgetState();
}

class _EquipLightBluePantsWidgetState extends State<EquipLightBluePantsWidget> {
  late EquipLightBluePantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipLightBluePantsModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_LIGHT_BLUE_PANTS_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.lightBluePants) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().cyanPantsEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_LIGHT_BLUE_PANTS_UNEQUIP_BTN_ON_TA');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_LIGHT_BLUE_PANTS_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
