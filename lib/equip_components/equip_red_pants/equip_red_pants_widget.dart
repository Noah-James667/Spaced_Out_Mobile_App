...
import 'equip_red_pants_model.dart';
export 'equip_red_pants_model.dart';

class EquipRedPantsWidget extends StatefulWidget {
  const EquipRedPantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipRedPantsWidget> createState() => _EquipRedPantsWidgetState();
}

class _EquipRedPantsWidgetState extends State<EquipRedPantsWidget> {
  late EquipRedPantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipRedPantsModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_RED_PANTS_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.redPants) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().redPantsEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_RED_PANTS_COMP_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_RED_PANTS_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
