...
import 'equip_green_ship_model.dart';
export 'equip_green_ship_model.dart';

class EquipGreenShipWidget extends StatefulWidget {
  const EquipGreenShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipGreenShipWidget> createState() => _EquipGreenShipWidgetState();
}

class _EquipGreenShipWidgetState extends State<EquipGreenShipWidget> {
  late EquipGreenShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipGreenShipModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_GREEN_SHIP_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.greenShip) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().greenShipEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_GREEN_SHIP_COMP_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_GREEN_SHIP_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
