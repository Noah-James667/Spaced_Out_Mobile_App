...
import 'equip_red_ship_model.dart';
export 'equip_red_ship_model.dart';

class EquipRedShipWidget extends StatefulWidget {
  const EquipRedShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<EquipRedShipWidget> createState() => _EquipRedShipWidgetState();
}

class _EquipRedShipWidgetState extends State<EquipRedShipWidget> {
  late EquipRedShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipRedShipModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<ShopItemsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EQUIP_RED_SHIP_COMP_EQUIP_BTN_ON_TAP');
                  if (buttonShopItemsRecord!.redShip) {
                    logFirebaseEvent('Button_update_app_state');
                    FFAppState().redShipEquip = 1;
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_RED_SHIP_COMP_UNEQUIP_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
              logFirebaseEvent('Button_update_app_state');
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('EQUIP_RED_SHIP_COMP_CANCEL_BTN_ON_TAP');
              logFirebaseEvent('Button_bottom_sheet');
              Navigator.pop(context);
            },
            text: 'Cancel',
