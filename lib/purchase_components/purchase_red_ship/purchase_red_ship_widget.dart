...
import 'purchase_red_ship_model.dart';
export 'purchase_red_ship_model.dart';

class PurchaseRedShipWidget extends StatefulWidget {
  const PurchaseRedShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseRedShipWidget> createState() => _PurchaseRedShipWidgetState();
}

class _PurchaseRedShipWidgetState extends State<PurchaseRedShipWidget> {
  late PurchaseRedShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseRedShipModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_RED_SHIP_COMP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_RED_SHIP_COMP_BUY_BTN_ON_TAP');
