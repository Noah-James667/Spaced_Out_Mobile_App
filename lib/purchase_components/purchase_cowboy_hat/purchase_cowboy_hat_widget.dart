...
import 'purchase_cowboy_hat_model.dart';
export 'purchase_cowboy_hat_model.dart';

class PurchaseCowboyHatWidget extends StatefulWidget {
  const PurchaseCowboyHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseCowboyHatWidget> createState() =>
      _PurchaseCowboyHatWidgetState();
}

class _PurchaseCowboyHatWidgetState extends State<PurchaseCowboyHatWidget> {
  late PurchaseCowboyHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseCowboyHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_COWBOY_HAT_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_COWBOY_HAT_COMP_BUY_BTN_ON_TAP');
