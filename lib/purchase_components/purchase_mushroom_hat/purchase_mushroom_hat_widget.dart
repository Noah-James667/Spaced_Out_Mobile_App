...
import 'purchase_mushroom_hat_model.dart';
export 'purchase_mushroom_hat_model.dart';

class PurchaseMushroomHatWidget extends StatefulWidget {
  const PurchaseMushroomHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseMushroomHatWidget> createState() =>
      _PurchaseMushroomHatWidgetState();
}

class _PurchaseMushroomHatWidgetState extends State<PurchaseMushroomHatWidget> {
  late PurchaseMushroomHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseMushroomHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_MUSHROOM_HAT_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_MUSHROOM_HAT_BUY_BTN_ON_TAP');
                      if (buttonShopItemsRecord!.mushroomHat) {
                        ...
                        await currentUserReference!.update({
                          ...mapToFirestore(
                            {
                              'coins': FieldValue.increment(-(1500)),
                            },
                          ),
                        });
                        logFirebaseEvent('Button_backend_call');
