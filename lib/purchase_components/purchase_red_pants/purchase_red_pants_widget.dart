...
import 'purchase_red_pants_model.dart';
export 'purchase_red_pants_model.dart';

class PurchaseRedPantsWidget extends StatefulWidget {
  const PurchaseRedPantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseRedPantsWidget> createState() => _PurchaseRedPantsWidgetState();
}

class _PurchaseRedPantsWidgetState extends State<PurchaseRedPantsWidget> {
  late PurchaseRedPantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseRedPantsModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_RED_PANTS_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_RED_PANTS_COMP_BUY_BTN_ON_TAP');
