...
import 'purchase_bow_hat_model.dart';
export 'purchase_bow_hat_model.dart';

class PurchaseBowHatWidget extends StatefulWidget {
  const PurchaseBowHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseBowHatWidget> createState() => _PurchaseBowHatWidgetState();
}

class _PurchaseBowHatWidgetState extends State<PurchaseBowHatWidget> {
  late PurchaseBowHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseBowHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_BOW_HAT_COMP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_BOW_HAT_COMP_BUY_BTN_ON_TAP');
