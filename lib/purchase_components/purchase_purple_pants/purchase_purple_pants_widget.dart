...
class PurchasePurplePantsWidget extends StatefulWidget {
  const PurchasePurplePantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchasePurplePantsWidget> createState() =>
      _PurchasePurplePantsWidgetState();
}

class _PurchasePurplePantsWidgetState extends State<PurchasePurplePantsWidget> {
  late PurchasePurplePantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchasePurplePantsModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_PURPLE_PANTS_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_PURPLE_PANTS_BUY_BTN_ON_TAP');
