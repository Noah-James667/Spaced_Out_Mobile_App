...
import 'purchase_unicorn_hat_model.dart';
export 'purchase_unicorn_hat_model.dart';

class PurchaseUnicornHatWidget extends StatefulWidget {
  const PurchaseUnicornHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseUnicornHatWidget> createState() =>
      _PurchaseUnicornHatWidgetState();
}

class _PurchaseUnicornHatWidgetState extends State<PurchaseUnicornHatWidget> {
  late PurchaseUnicornHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseUnicornHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_UNICORN_HAT_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_UNICORN_HAT_COMP_BUY_BTN_ON_TAP');
