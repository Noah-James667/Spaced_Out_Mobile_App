...
class PurchaseYellowShipWidget extends StatefulWidget {
  const PurchaseYellowShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseYellowShipWidget> createState() =>
      _PurchaseYellowShipWidgetState();
}

class _PurchaseYellowShipWidgetState extends State<PurchaseYellowShipWidget> {
  late PurchaseYellowShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseYellowShipModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_YELLOW_SHIP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_YELLOW_SHIP_COMP_BUY_BTN_ON_TAP');
