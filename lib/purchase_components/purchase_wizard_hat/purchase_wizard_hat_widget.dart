...
import 'purchase_wizard_hat_model.dart';
export 'purchase_wizard_hat_model.dart';

class PurchaseWizardHatWidget extends StatefulWidget {
  const PurchaseWizardHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseWizardHatWidget> createState() =>
      _PurchaseWizardHatWidgetState();
}

class _PurchaseWizardHatWidgetState extends State<PurchaseWizardHatWidget> {
  late PurchaseWizardHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseWizardHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_WIZARD_HAT_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_WIZARD_HAT_COMP_BUY_BTN_ON_TAP');
                      if (buttonShopItemsRecord!.wizardHat) {
                        ...
                        await currentUserReference!.update({
                          ...mapToFirestore(
                            {
                              'coins': FieldValue.increment(-(3000)),
                            },
                          ),
                        });
                        logFirebaseEvent('Button_backend_call');
