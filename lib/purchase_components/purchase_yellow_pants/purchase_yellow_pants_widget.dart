...
import 'purchase_yellow_pants_model.dart';
export 'purchase_yellow_pants_model.dart';

class PurchaseYellowPantsWidget extends StatefulWidget {
  const PurchaseYellowPantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseYellowPantsWidget> createState() =>
      _PurchaseYellowPantsWidgetState();
}

class _PurchaseYellowPantsWidgetState extends State<PurchaseYellowPantsWidget> {
  late PurchaseYellowPantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseYellowPantsModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_YELLOW_PANTS_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_YELLOW_PANTS_BUY_BTN_ON_TAP');
