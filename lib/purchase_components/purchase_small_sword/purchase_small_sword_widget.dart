...
import 'purchase_small_sword_model.dart';
export 'purchase_small_sword_model.dart';

class PurchaseSmallSwordWidget extends StatefulWidget {
  const PurchaseSmallSwordWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseSmallSwordWidget> createState() =>
      _PurchaseSmallSwordWidgetState();
}

class _PurchaseSmallSwordWidgetState extends State<PurchaseSmallSwordWidget> {
  late PurchaseSmallSwordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseSmallSwordModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_SMALL_SWORD_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_SMALL_SWORD_COMP_BUY_BTN_ON_TAP');
