...
import 'purchase_light_blue_pants_model.dart';
export 'purchase_light_blue_pants_model.dart';

class PurchaseLightBluePantsWidget extends StatefulWidget {
  const PurchaseLightBluePantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseLightBluePantsWidget> createState() =>
      _PurchaseLightBluePantsWidgetState();
}

class _PurchaseLightBluePantsWidgetState
    extends State<PurchaseLightBluePantsWidget> {
  late PurchaseLightBluePantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseLightBluePantsModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_LIGHT_BLUE_PANTS_CANCEL_BTN_ON_');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_LIGHT_BLUE_PANTS_BUY_BTN_ON_TAP');
