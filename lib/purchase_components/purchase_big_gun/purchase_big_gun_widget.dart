...
class PurchaseBigGunWidget extends StatefulWidget {
  const PurchaseBigGunWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseBigGunWidget> createState() => _PurchaseBigGunWidgetState();
}

class _PurchaseBigGunWidgetState extends State<PurchaseBigGunWidget> {
  late PurchaseBigGunModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseBigGunModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_BIG_GUN_COMP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_BIG_GUN_COMP_BUY_BTN_ON_TAP');
