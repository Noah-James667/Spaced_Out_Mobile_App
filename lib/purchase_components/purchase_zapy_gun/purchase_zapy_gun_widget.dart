...
class PurchaseZapyGunWidget extends StatefulWidget {
  const PurchaseZapyGunWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseZapyGunWidget> createState() => _PurchaseZapyGunWidgetState();
}

class _PurchaseZapyGunWidgetState extends State<PurchaseZapyGunWidget> {
  late PurchaseZapyGunModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseZapyGunModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_ZAPY_GUN_COMP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_ZAPY_GUN_COMP_BUY_BTN_ON_TAP');
