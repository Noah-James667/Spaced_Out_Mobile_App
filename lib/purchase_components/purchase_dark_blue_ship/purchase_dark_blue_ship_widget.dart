...
import 'purchase_dark_blue_ship_model.dart';
export 'purchase_dark_blue_ship_model.dart';

class PurchaseDarkBlueShipWidget extends StatefulWidget {
  const PurchaseDarkBlueShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseDarkBlueShipWidget> createState() =>
      _PurchaseDarkBlueShipWidgetState();
}

class _PurchaseDarkBlueShipWidgetState
    extends State<PurchaseDarkBlueShipWidget> {
  late PurchaseDarkBlueShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseDarkBlueShipModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_DARK_BLUE_SHIP_CANCEL_BTN_ON_TA');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_DARK_BLUE_SHIP_BUY_BTN_ON_TAP');
