...
import 'purchase_top_hat_model.dart';
export 'purchase_top_hat_model.dart';

class PurchaseTopHatWidget extends StatefulWidget {
  const PurchaseTopHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseTopHatWidget> createState() => _PurchaseTopHatWidgetState();
}

class _PurchaseTopHatWidgetState extends State<PurchaseTopHatWidget> {
  late PurchaseTopHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseTopHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_TOP_HAT_COMP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('PURCHASE_TOP_HAT_COMP_BUY_BTN_ON_TAP');
                      if (buttonShopItemsRecord!.topHat) {
