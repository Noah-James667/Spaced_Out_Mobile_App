...
import 'purchase_green_pants_model.dart';
export 'purchase_green_pants_model.dart';

class PurchaseGreenPantsWidget extends StatefulWidget {
  const PurchaseGreenPantsWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseGreenPantsWidget> createState() =>
      _PurchaseGreenPantsWidgetState();
}

class _PurchaseGreenPantsWidgetState extends State<PurchaseGreenPantsWidget> {
  late PurchaseGreenPantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseGreenPantsModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_GREEN_PANTS_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_GREEN_PANTS_COMP_BUY_BTN_ON_TAP');
