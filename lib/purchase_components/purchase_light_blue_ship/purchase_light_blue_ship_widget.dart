...
import 'purchase_light_blue_ship_model.dart';
export 'purchase_light_blue_ship_model.dart';

class PurchaseLightBlueShipWidget extends StatefulWidget {
  const PurchaseLightBlueShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseLightBlueShipWidget> createState() =>
      _PurchaseLightBlueShipWidgetState();
}

class _PurchaseLightBlueShipWidgetState
    extends State<PurchaseLightBlueShipWidget> {
  late PurchaseLightBlueShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseLightBlueShipModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_LIGHT_BLUE_SHIP_CANCEL_BTN_ON_T');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_LIGHT_BLUE_SHIP_BUY_BTN_ON_TAP');
