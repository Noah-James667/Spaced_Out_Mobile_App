...
import 'purchase_space_sword_model.dart';
export 'purchase_space_sword_model.dart';

class PurchaseSpaceSwordWidget extends StatefulWidget {
  const PurchaseSpaceSwordWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchaseSpaceSwordWidget> createState() =>
      _PurchaseSpaceSwordWidgetState();
}

class _PurchaseSpaceSwordWidgetState extends State<PurchaseSpaceSwordWidget> {
  late PurchaseSpaceSwordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseSpaceSwordModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_SPACE_SWORD_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_SPACE_SWORD_COMP_BUY_BTN_ON_TAP');
