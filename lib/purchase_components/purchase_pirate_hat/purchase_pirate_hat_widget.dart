...
import 'purchase_pirate_hat_model.dart';
export 'purchase_pirate_hat_model.dart';

class PurchasePirateHatWidget extends StatefulWidget {
  const PurchasePirateHatWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchasePirateHatWidget> createState() =>
      _PurchasePirateHatWidgetState();
}

class _PurchasePirateHatWidgetState extends State<PurchasePirateHatWidget> {
  late PurchasePirateHatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchasePirateHatModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_PIRATE_HAT_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_PIRATE_HAT_COMP_BUY_BTN_ON_TAP');
                      if (buttonShopItemsRecord!.pirateHat) {
                        ...
                        await currentUserReference!.update({
                          ...mapToFirestore(
                            {
                              'coins': FieldValue.increment(-(750)),
                            },
                          ),
                        });
                        logFirebaseEvent('Button_backend_call');
