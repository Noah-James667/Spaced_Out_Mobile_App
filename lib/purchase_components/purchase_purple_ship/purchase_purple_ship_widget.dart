...
import 'purchase_purple_ship_model.dart';
export 'purchase_purple_ship_model.dart';

class PurchasePurpleShipWidget extends StatefulWidget {
  const PurchasePurpleShipWidget({
    super.key,
    this.cost,
    this.img,
  });
  ...
  @override
  State<PurchasePurpleShipWidget> createState() =>
      _PurchasePurpleShipWidgetState();
}

class _PurchasePurpleShipWidgetState extends State<PurchasePurpleShipWidget> {
  late PurchasePurpleShipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchasePurpleShipModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('PURCHASE_PURPLE_SHIP_CANCEL_BTN_ON_TAP');
              ...
              StreamBuilder<List<ShopItemsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PURCHASE_PURPLE_SHIP_COMP_BUY_BTN_ON_TAP');
